    ...
    Datepicker.prototype = {
        ...
        fill: function() {
            ...
            if (year == startYear) {
                ...
                months.slice(0, startMonth).addClass('');
            }
            if (year == endYear) {
               /* months.slice(endMonth + 1).addClass('disabled');*/
                 months.slice(endMonth + 1).addClass('');
            }
            ...
            year -= 1;
            for (var i = -1; i < 11; i++) {
                html += '<span class="year' + (i == -1 || i == 10 ? ' old' : '') + (currentYear == year ? ' active' : '') + (year < startYear || year > endYear ? ' ' : '') + '">' + year + '</span>';
                year += 1;
            }
            yearCont.html(html);
        },
